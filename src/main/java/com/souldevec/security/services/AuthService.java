...
public class AuthService {
    ...
    public void registerUser(NewUserDto newUserDto){
        ...
        RoleList roleList = "admin".equalsIgnoreCase(newUserDto.getRole()) ? RoleList.ROLE_ADMIN : RoleList.ROLE_USER;
        Role roleUser = roleRepository.findByName(roleList).orElseThrow(()->new RuntimeException("Rol no encontrado"));
